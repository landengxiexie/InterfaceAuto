...
//        选择，用户组
        WebElement selectGroup = l.getElement(param.get("chooseWorkingGroup"));
        selectGroup.click();
        String text1 = selectGroup.getText();
        LogFunction.logInfo("选择：" + text1);
        AssertFunction.verifyEquals(driver, text1, param.get("editWorkingGroupNameValue"), "----是否选择" + param.get("createWorkingGroupNameValue") + "工作组----");
//        点击，右移按钮
...
//        选择域：BJDomain
        ...
        AssertFunction.verifyEquals(driver, text2, "BJDomain", "----验证是否选择域：XMDomain----");
...
//        选择域：XMDomain
        ...
        domainName.click();
        LogFunction.logInfo("选择：" + text2);
        AssertFunction.verifyEquals(driver, text2, "XMDomain", "----验证是否选择域：XMDomain----");
