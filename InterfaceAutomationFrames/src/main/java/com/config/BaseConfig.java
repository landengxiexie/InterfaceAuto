...
//    public static String beanName7;
//    public static String beanName77;
    public static String queryUserInfoURL;
    public static String DoLoginURL;
    public static String DoLoginParams;
    public static String getFunctionsByUserIdURL;
    public static String getFunctionsByUserIdParams;
    public static String queryAllObjectsByUserIdURL;
    public static String queryAllObjectsByUserIdParams;
    public static String getUserViewsByTypeURL;
    public static String getUserViewsByTypeParams;
    public static String getMyViewEntriesNoContentURL;
    public static String getMyViewEntriesNoContentParams;
    public static String queryGroupInfoLikeURL;
    public static String queryGroupInfoLikeParams;
    public static String getAllDomainsURL;
    public static String createGroupURL;
    public static String createGroupParams;
    public static String addViewURL;
    public static String addViewParams;
    public static String grantObjects2GroupURL;
    public static String grantObjects2GroupParams;
    public static String queryGroupInfoURL;
    public static String queryUsersByGroupIdURL;
    public static String queryUsersByGroupIdParams;
    public static String grantUsers2GroupURL;
    public static String grantUsers2GroupParams;
    public static String disableGroupURL;
    public static String disableGroupParams;
    public static String getViewsExcludeKpiAndDeskTopURL;
    public static String deleteGroupURL;
    public static String deleteGroupParams;
    public static String getAllFunctionsURL;
    public static String findByModelNameURL;
    public static String findByModelNameParams;
    public static String queryObjectsByGroupIdURL;
    public static String queryObjectsByGroupIdParams;
    public static String grantMenuAmoduleAview2UserURL;
    public static String grantMenuAmoduleAview2UserParams;
    public static String grantObjectsDomainURL;
    public static String grantObjectsDomainParams;
    public static String queryUserInfo2URL;
    public static String queryAuditInfoURL;
    public static String queryAuditInfoParams;
    public static String insertBaseLinePolicyURL;
    public static String insertBaseLinePolicyParams;
    public static String getBaseLinePolicyListURL;
    public static String getBaseLinePolicyListParams;
    public static String updateBaseLinePolicyURL;
    public static String updateBaseLinePolicyParams;
    public static String cleanBaseLinePolicyURL;
    public static String cleanBaseLinePolicyParams;
    public static String queryWarningRuleListURL;
    public static String queryWarningRuleListParams;
    public static String getAllTypeNodesURL;
    public static String getAllTypeNodesParams;
    public static String getAllMyNodesByTypeNameURL;
    public static String getAllMyNodesByTypeNameParams;
    public static String getBaseLineDefListURL;
    public static String getBaseLineDefListParams;
    public static String getKpiItemListURL;
    public static String getKpiItemListParams;
    public static String getOneWarningRuleURL;
    public static String getOneWarningRuleParams;
    public static String checkBaseLineDefURL;
    public static String checkBaseLineDefParams;
    public static String insertBaseLineDefURL;
    public static String insertBaseLineDefParams;
    public static String updateBaseLineCalendarByBatchURL;
    public static String updateBaseLineCalendarByBatchParams;
    public static String getBaseLineCalendarListURL;
    public static String getBaseLineCalendarListParams;
    public static String cleanBaseLineDefURL;
    public static String cleanBaseLineDefParams;
    public static String findModelTreeURL;
    public static String findModelTreeParams;
    public static String getEnumsURL;
    public static String getEnumsParams;
    public static String findInstanceByModelSortOrderURL;
    public static String findInstanceByModelSortOrderParams;
    public static String getAllDictsURL;
    public static String queryByFilterURL;
    public static String queryByFilterParams;
    public static String findAllURL;
    public static String findSelectTreeURL;
    public static String findSelectTreeParams;
    public static String findByOperationTypeAndModelNameURL;
    public static String findByOperationTypeAndModelNameParams;
    public static String findURL;
    public static String findParams;
    public static String queryByFilter2URL;
    public static String queryByFilter2Params;
    public static String addURL;
    public static String addParams;
    public static String findByNameNotBuiltInAttrURL;
    public static String findByNameNotBuiltInAttrParams;
    public static String updateURL;
    public static String updateParams;
    public static String removeURL;
    public static String removeParams;
    public static String relationAttributeServiceAddURL;
    public static String relationAttributeServiceAddParams;
    public static String findByIdURL;
    public static String findByIdParams;
    public static String removeBatchURL;
    public static String removeBatchParams;
    public static String findListURL;
    public static String findListParams;
    public static String instanceHistoryServiceFindURL;
    public static String instanceHistoryServiceFindParams;
    public static String queryFilterByColorAdminURL;
    public static String queryFilterByColorAdminParams;
    public static String getDefulateValueURL;
    public static String getDefulateValueParams;
    public static String queryInstanceByRelationPageURL;
    public static String queryInstanceByRelationPageParams;
    public static String validationURL;
    public static String validationParams;
    public static String instanceServiceAddURL;
    public static String instanceServiceAddParams;
    public static String instanceServiceFindByIdURL;
    public static String instanceServiceFindByIdParams;
    public static String findByNameURL;
    public static String findByNameParams;
    public static String findBySourceOrTarget_LabelURL;
    public static String findBySourceOrTarget_LabelParams;
    public static String findBySourceOrTargetURL;
    public static String findBySourceOrTargetParams;
    public static String instanceServiceUpdateURL;
    public static String instanceServiceUpdateParams;
    public static String checkRelationURL;
    public static String checkRelationParams;
    public static String checkInstanceHasRelationURL;
    public static String checkInstanceHasRelationParams;
    public static String instanceServiceRemoveURL;
    public static String instanceServiceRemoveParams;
    public static String waitForConfirmationCountURL;
    public static String confirmationedCountURL;
    public static String getWaitForConfirmationListURL;
    public static String getWaitForConfirmationListParams;
    public static String getConfirmationedListURL;
    public static String getConfirmationedListParams;
    public static String getUrmpTreeByKeyFilterURL;
    public static String getUrmpTreeByKeyFilterParams;
    public static String statisticAlertCountByStateCacheURL;
    public static String statisticAlertCountByStateCacheParams;
    public static String queryIncidentTypeURL;
    public static String queryFullUserInfoURL;
    public static String getForwardTypeMapURL;
    public static String getGlobalModuleURL;
    public static String getGlobalModuleParams;
    public static String countAlertFromCacheForHtmlDataURL;
    public static String countAlertFromCacheForHtmlDataParams;
    public static String queryAlertFromCacheForHtmlDataURL;
    public static String queryAlertFromCacheForHtmlDataParams;
    public static String sendAlertClaimActionURL;
    public static String sendAlertClaimActionParams;
    public static String sendForwordActionURL;
    public static String sendForwordActionParams;
    public static String sendAlertRecoverActionURL;
    public static String sendAlertRecoverActionParams;
    public static String getNodeByNameURL;
    public static String getNodeByNameParams;
    public static String queryEventURL;
    public static String queryEventParams;
    public static String queryActionLogURL;
...
//        url7=p.getElementText("*/url7");
//        beanName7=p.getElementText("*/beanName7");
//        beanName77=p.getElementText("*/beanName77");
