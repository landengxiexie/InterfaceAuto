...
public class Test001 {
    ...
    @Test
    public void a() {
        HashMap<String, String> params = ParseXML.readXMLDocument(BaseConfig.beanName);
        JSONObject post = httpFunction.post(BaseConfig.url,params,2);
        System.out.println(post);
    }
    @Test
    public void d1() {
        HashMap<String, String> params = ParseXML.readXMLDocument(BaseConfig.beanName4);
        JSONObject jsonObject = httpFunction.get(BaseConfig.url4, params);
    ...
    public void d2() {
        ...
        JSONObject jsonObject = httpFunction.get(BaseConfig.url5, params);
        System.out.println(jsonObject);
        AssertFunction.verifyEquals("this is  get  cookies request",jsonObject.get("msg"),"-");
    }
    @Test(dependsOnMethods = "d2")
    public void t1() {
        JSONObject post = httpFunction.post(BaseConfig.url);
        System.out.println(post);
    ...
    public void t2() {
        ...
        JSONObject post = httpFunction.post(BaseConfig.url2,params,2);
        System.out.println(post);
        AssertFunction.verifyEquals("success",post.get("asd"),"-");
    ...
    public void t3() {
        ...
        JSONObject post = httpFunction.post(BaseConfig.url3,"header3",params,2);
        System.out.println(post);
        AssertFunction.verifyEquals("success",post.get("asd"),"-");
    ...
    public void aa() {
        ...
        JSONObject header = httpFunction.post(BaseConfig.url, "header", params, 1);
    ...
    public void cc() {
        ...
        JSONObject jsonObject = httpFunction.get(BaseConfig.url, "header", params);
        System.out.println(jsonObject);
