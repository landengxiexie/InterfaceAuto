...
public class TestBase  {
    ...
    private void initialPF() {
        if (pf == null) {
            ...
            pf.readXML("src/test-data/" + this.getClass().getSimpleName() + ".xml");
        }
    }
...
//            Object[] temp = new Object[]{this.getMergeMapData(pf.getChildrenInfoByElement(elements.get(i)),commonMap)};
    ...
    public  void rmdirScreenshot(){
        try {
//            cmd /c start是固定写法
            String cmd  = "cmd /c start del /q D:\\PersonProject\\Vicube\\UIAutomantionVicube2018_11_12\\testScreen\\*";
