    ...
    public static void main(String[] args) {
        ...
        Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                ...
                return new PasswordAuthentication("3356939919@qq.com", "cqgbjygcogxmchfi");
        ...
        try {
            ...
            // 设置发件人邮箱地址
            message.setFrom(new InternetAddress("3356939919@qq.com"));

            // 设置收件人邮箱地址
            message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("652444917@qq.com"));
